...
TARGET_DIR = os.path.abspath("app/templates")
STATIC_DIR = os.path.abspath("app/static/css")

def audit_files():
    print("🚀 Starting Web Design Guidelines Audit...\n")
                ...
                if file.endswith((".css", ".scss")):
                    ...
                    with open(path, "r", encoding="utf-8") as f:
                        ...
                        if "transition: all" in content or "transition-all" in content:
                            # Note: transition-all class in Tailwind is valid but check logic
        ...
        for file in files:
            if file.endswith(".html"):
                ...
                with open(path, "r", encoding="utf-8") as f:
                    ...
                    for inp in inputs:
                         # Basic heuristic
                        if 'type="text"' in inp or 'type="email"' in inp:
